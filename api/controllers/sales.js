...
export const getAllSales = (request, response, next) => {
  salesModel.find()
...
export const getOneSale = (request, response, next) => {
...
export const createSale = (request, response, next) => {
...
export const updateSale = async (request, response, next)=>{
  try{
...
export const deleteSale = async (request, response, next)=>{
  try{
